...
class Internship(db.Model):
    ...
    #are bug, spune ca nu gaseste tabelul Users     ????
    #representative_id = db.Column("representative_id", db.Integer, db.ForeignKey('Users.id'))
    representative_id = db.Column("representative_id", db.Integer)
    ...
    def __init__(self, representative_id, year, start_date, end_date,awards,rewards,otherConditions
